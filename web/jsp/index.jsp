...
<div class="page-content">
	<div class="content">
		...
		<blockquote class="layui-elem-quote">
			欢迎使用宝盈科技车载移动数据云端在线管理系统和数据分析管理软件【MA969YDYZM-S】<span class="f-14">V1.0</span><br>
			<span style="color: red;">注意：每个页面都可以独立设置一个背景主题，如果每个都设置会比较消耗本地的存储，如果想全部恢复，请重置。|
			...
			<div
				...
				<blockquote>
					<select class="showtran layui-input" onchange="getTransmitById()"
						...
						onclick="startscreen()" class="layui-btn" value="动态显示" id="srun" /><input
						type="button" class="layui-btn " value="全屏"
