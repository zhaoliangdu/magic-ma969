...
<div class="page-content">
    <div class="content">
        ...
        <blockquote class="layui-elem-quote">
            欢迎使用宝盈科技车载移动数据云端在线管理系统和数据分析管理软件【MA969YDYZM-S】<span class="f-14">V1.0</span><br><span
                style="color: red;">注意：每个页面都可以独立设置一个背景主题，如果每个都设置会比较消耗本地的存储，如果想全部恢复，请重置。|
				本平台尽量使用谷歌浏览器打开，IE可能导致某些功能不能使用</span>
        </blockquote>
        <blockquote class="layui-elem-quote">注册时间：${createtime }&nbsp;&nbsp;
            上次登录时间：${lastLoginTime }&nbsp;&nbsp;IP：${ipAddr }</blockquote>
        ...
        <div style="min-width: 1000px;">
            <div style="float: left;width: 20%;min-width:200px;height: 800px;overflow-y:scroll;">
                <blockquote >
                <h2>台站信息</h2><br>
                <select class="showtran layui-input" onchange="getTransmitById()"
                        id="showtran"></select><input type="button"
                                                      ...
                                                      id="srun"/><input
                    type="button" class="layui-btn " value="全屏" onclick="fullscreen('台站信息','${pageContext.servletContext.contextPath}/fullscreen','1900','950')"/>&nbsp;&nbsp;<input
